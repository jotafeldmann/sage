...
Add co-located tests at src/BookInventory.test.tsx using the configured Vitest globals, React Testing Library and user-event, covering title search, publication-year sorting, and the empty state.
